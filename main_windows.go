...
func main() {
	...
	localUI = ui2.NewLocalUI(&myWindow, &configInfo)
	localUI_Container := localUI.GetContainer()

	remoteUI = ui2.NewRemoteUI(&myWindow, &configInfo)

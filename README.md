...
2. P2P连接前, 两端通过公网Redis服务交互信息。默认使用作者提供的Redis服务

3. P2P连接基于QUIC，高性能，已加密

4. P2P连接过程复杂，会出现反复重试，通常60秒内成功。如果长时间无法连接，请[反馈我](https://gitee.com/konyshe/goodlink/issues)解决，谢谢！
...
注：如果不想用作者的Redis服务, 可参考-h选项说明, 指定自己的Redis服务地址

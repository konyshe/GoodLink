...
1. 客户端和服务端之间直连！直连！直连！不经过第三方服务器，不需要担心数据隐私泄露

2. 一条命令搞定，无需安装、无需注册，无需公网IP，无需配置文件

3. 创建连接时, 会用到Redis服务。默认使用作者提供的Redis服务。也可参考-h选项说明, 指定自己的Redis服务，完全私有化

4. 连接基于QUIC，高性能，已加密

5. 由于连接过程复杂，会出现反复重试，通常60秒内成功。如果长时间无法连接，请[反馈我](https://gitee.com/konyshe/goodlink/issues)解决！

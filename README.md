...
将家里 NAS（需要被远程访问的电脑）的 9999 端口，穿透到公司内网电脑（需要请求访问的本地电脑）的 18080 端口。隧道建立成功后，浏览器访问本地 http://127.0.0.1:18080，即可访问到家里NAS的管理页面（9999端口）。

注：此时目前仅支持穿透 TCP 协议，UDP 协议还在开发中

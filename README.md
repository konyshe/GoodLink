...
5. 由于Local端需要创建虚拟网卡，因此一个PC端只能运行一个 local 端，否则会互相冲突

6. 由于直连过程复杂, 会出现反复重试, 通常 10 分钟内成功。如果长时间无法连接, [反馈我解决](https://gitee.com/konyshe/goodlink/issues)
...
10. 该项目刚刚起步, 可能不太稳定, 欢迎到 Issues 上提出问题和建议, 帮忙测试的同学将保证永久免费使用
